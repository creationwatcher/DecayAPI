...
do
	...
	finder, global_container = loadstring(
		game:HttpGet("https://raw.githubusercontent.com/creationwatcher/DecayAPI/refs/heads/main/MethodFinder.lua", true)
	)()
...
pcall(function()
    hashlib_sha384 = loadstring(
        game:HttpGet("https://raw.githubusercontent.com/creationwatcher/DecayAPI/refs/heads/main/RequireModule.lua", true)
    )()(4544052033).sha384
end)
